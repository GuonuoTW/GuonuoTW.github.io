...
Based on their dependent stats, energy pools can be categorized into Physic Energy Pools, Mental Energy Pools, and Social Energy Pools. If the Energy Pool's dependent stats is from two different stat categories, the Energy Pool belongs in both categories.
